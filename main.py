...
# ========================================
TOKEN = "8868888185:AAHUSoWiA_NZD9v_h61EYGRHXSJGjJq8Csg"       #YOUR BOT TOKEN HERE
...
firebase_credentials_json = r"""
{
  ...
  "project_id": "jihan1bit",
  "private_key_id": "54f4be1c65bce265e17a39fff93c6df20c8b3dcd",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@jihan1bit.iam.gserviceaccount.com",
  "client_id": "114163351888652322552",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40jihan1bit.iam.gserviceaccount.com",
...
def mask_number(num):
    clean = num.replace("+", "").replace(" ", "")
    if len(clean) > 6: return f"{clean[:3]}ʀᴄᴠ{clean[-3:]}"
    elif len(clean) > 2: return f"{clean[:1]}ʀᴄᴠ{clean[-1:]}"
    return clean
